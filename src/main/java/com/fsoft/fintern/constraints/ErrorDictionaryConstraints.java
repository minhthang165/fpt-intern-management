...
public enum ErrorDictionaryConstraints {
    ...
    // FEEDBACKS
    FEEDBACK_NOT_EXIST_ID("There is no feedback with this ID"),
    FEEDBACK_IS_EMPTY("There are no feedbacks"),
    FEEDBACK_IS_NOT_FOUND("Can not found feedback"),
    FEEDBACK_IS_ALREADY_EXISTS("There is already a feedback with this ID");
