...
public class ExcelTemplateGenerator {
    ...
    private void createClassesSheet(Workbook workbook) {
        ...
        Cell cellMentorId = headerRow.createCell(5);
        cellMentorId.setCellValue("CodeMentorID");

        Cell cellLanguageId = headerRow.createCell(6);
        cellLanguageId.setCellValue("LanguageMentorID");
